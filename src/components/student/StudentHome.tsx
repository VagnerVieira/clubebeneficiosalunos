          ...
          <div className="mt-5 p-4 rounded-2xl bg-white/10 backdrop-blur-md border border-white/15">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <div className="text-right">
                <div className="text-[11px] text-blue-200">Válido até</div>
            ...
            <div className="mt-3 pt-3 border-t border-white/10 flex items-center justify-between text-xs">
              <span className="text-blue-100">
                {validity.daysRemaining > 0 ? (
                  <>
                    Restam <strong>{validity.daysRemaining} dias</strong> de vigência
                  </>
                ) : (
                  <strong className="text-rose-300">Acesso expirado</strong>
                )}
              </span>
